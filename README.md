...
This is the main repository for all of the projects in the directory.
...
**NOTE ON PULL REQUESTS**: All of these projects are part of the daily challenge. While I do appreciate people trying to make some things prettier or adding new features, we are only accepting pull requests and looking at issues for bug fixes so that the code stays inline.
